...
{     
  ...
  n.param<double>("vel_linear",vlinear,0.1);//默认线速度0.1 m/s
  n.param<double>("vel_angular",vangular,0.3);//默认角速度0.3 单位rad/s

  pub = n.advertise<geometry_msgs::Twist>("/turtlebot_teleop/cmd_vel",1);
